...
def save_landmarks_csv(folder, risultato):
    if not folder or not risultato.hand_landmarks: return False
...
def draw_prediction_panel(frame, w, h, letter, confidence, top3):
...
def main():
    ...
    while True:
        ...
        if mano_sx: draw_panel(frame, mano_sx, 10, 80, "Mano Sinistra")
        if mano_dx: draw_panel(frame, mano_dx, w - 230, 80, "Mano Destra")
        ...
        draw_prediction_panel(frame, w, h, best_letter, best_conf, best_top3)
